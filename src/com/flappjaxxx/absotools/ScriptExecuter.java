...
public class ScriptExecuter extends AsyncTask<String, String, Integer> {
	...
	static final String CMD_ABSOTOOL="/system/bin/absotool";
    ...
    protected void onPostExecute(Integer result) {
    	consoleView.append("==== Finished ====\n");
    }	

    private Integer executeCommand(String cmd) {
		consoleView = ToolsActivity.getInstance().getConsoleView();
		Process   p = null;
		int       rc = -1;
		...
		try {
		    ...
		    os.writeBytes(CMD_ABSOTOOL + " " + cmd + "\n" + "; exit\n"); 
		    os.flush();

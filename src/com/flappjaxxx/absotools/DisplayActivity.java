...
public class DisplayActivity extends ScriptedActivity {
	...
	public void onCreate(Bundle savedInstanceState) {		
		this.actions      = getResources().getStringArray(R.array.display_actions_array);
		this.descriptions = getResources().getStringArray(R.array.display_descriptions_array);
